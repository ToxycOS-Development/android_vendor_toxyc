...
custom_local_manifest = ".repo/local_manifests/toxyc_manifest.xml"
custom_default_revision = "r4.x"
custom_dependencies = "toxyc.dependencies"
org_manifest = "toxycOS-Devices"  # leave empty if org is provided in manifest
org_display = "ToxycOS-Devices"  # needed for displaying
